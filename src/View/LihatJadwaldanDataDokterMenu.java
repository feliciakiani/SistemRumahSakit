 ...
 * @author User
 */
public class LihatJadwaldanDataDokterMenu {
    JFrame frame;
    JPanel panel;
    ...
    public LihatJadwaldanDataDokterMenu() {
        ...
        labelThisMenu = new JLabel("Menu Lihat Data Dokter");
        ...
        btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (!_firstName.equals("") && !_lastName.equals("")) {
                    ...
                    p.lihatJadwaldanDataDokter(_firstName, _lastName);
                } else {
                    frame.setVisible(false);
                    JOptionPane.showMessageDialog(null, "Anda belum memililh dokter", "Lihat Jadwal dan Data Dokter", JOptionPane.ERROR_MESSAGE);
